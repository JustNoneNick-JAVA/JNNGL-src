package com.jnngl.library.draw3d.cube;
...
public class DPolygon {
	...
	void updatePolygon()
	{
		...
		{
			newX[i] = dx + Display.getWidth()/2 + 50 * Calculator.CalculatePositionX(Screen.ViewFrom, Screen.ViewTo, x[i], y[i], z[i]);
			newY[i] = dy + Display.getHeight()/2 + 50 * Calculator.CalculatePositionY(Screen.ViewFrom, Screen.ViewTo, x[i], y[i], z[i]);
		}
